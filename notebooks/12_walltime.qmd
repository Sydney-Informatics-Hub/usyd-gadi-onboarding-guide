...
```bash
gadi serial PBS script goes here.
```

We can add an extra flag to this script to set the number of iterations we would like and the name of the checkpointed model we ould like to save by changing the script parameters in the above script to:

```bash
updated python command goes here
```
...
```bash
continuation pbs script goes here
```
