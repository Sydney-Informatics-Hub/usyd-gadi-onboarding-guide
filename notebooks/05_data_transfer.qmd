...
To transfer data between Artemis and Gadi from the Artemis login shell:
  ...
  1. Open a terminal and ssh into Artemis:
...
If you want to copy the other way around (ie. from Gadi /scratch to RDS) then simple reverse the order of the above command in step 2, e.g:
...
Copies of these scripts have been placed in `/scratch/qc03/data-transfer-scripts/`. 
