...
2. In the 'Collection' search box on the 'File manager' tab, search for your NCI endpoint. For NCI-managed `/g/data` endpoints, type your NCI project ID and select the collection, eg “NCI USYDNEY nci-project-id”. This will open `/g/data/` (your storage on NCI) in the left-hand pane. If you are using a personal `/scratch` endpoint, search for the name you assigned this collection during setup.
