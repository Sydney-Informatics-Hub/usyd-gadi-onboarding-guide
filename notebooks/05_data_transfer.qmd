...
+-------------------------------------------+---------------------------------------+----------------------------------------------------------------+
| [Globus](#globus)                         | Any file/dataset size.                | - [Fast and easy transfer with integrated checksum]{style="color: blue;"}                 |
|                                           |                                       | - [Web app/GUI for drag and drop transfers]{style="color: blue;"}                                |
|                                           |                                       | - [Command-line tool]{style="color: blue;"}             |
|                                           |                                       | - [Must review and accept data security policy]{style="color: red;"}   |
+-------------------------------------------+---------------------------------------+----------------------------------------------------------------+
...
[Globus](https://sydneyuni.atlassian.net/wiki/spaces/RC/pages/3492052996/Globus+Data+Transfer) is a data transfer service that makes it easier to copy data around. Instead of data transfers running on your local computer, you submit data transfer requests to the Globus service, and the data transfers happen on Globus servers independently of your local computer. Globus can verify all data is successfully transferred and retry transfers until they succeed.

#### Requesting Globus for your project

The lead chief investigator of each project must review the [Privacy Collection Notice](https://sydneyuni.service-now.com/sm?id=kb_article_view&sysparm_article=KB0037229) and let us know whether they approve Globus endpoints for their NCI/Pawsey and RDS projects or not.  Opt-in via DashR will be available soon. Until then, please contact [Sydney Informatics Hub](https://sydney.au1.qualtrics.com/jfe/form/SV_5mXyhFZsPIwZDBs) to request Globus access for your project/s. 
...
2. In the 'Collection' search box on the 'File manager' tab, type your NCI project ID and select the collection, eg “NCI USYDNEY nci-project-id”. This will open `/g/data/` (your storage on NCI) in the left-hand pane.
