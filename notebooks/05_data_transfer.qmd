...
9. Connect to USyd's Artemis/RDS system using sftp and your unikey:
...
11. Exit your sftp connection to USyd's Artemis/RDS system `ctrl + z` and test the passwordless connection: 
