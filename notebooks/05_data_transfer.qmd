...
|  Artemis terminal](#rs)                   |                                       | - [Restarts after interruption]{style="color: blue;"}          |
|                                           |                                       | - [Uses login node for computation]{style="color: red;"}       |
|                                           |                                       | - [Artemis only around until August]{style="color: red;"}      |
+-------------------------------------------+---------------------------------------+----------------------------------------------------------------+
| [sftp copy using dataq](#sdataq)          | Large files and datasets              | - [Robust, runs in background]{style="color: blue;"}           |
|                                           | to copy all in one go.                | - [Faster speed than `lftp`]{style="color: blue;"}             |
|                                           |                                       | - [Always copies all files]{style="color: red;"}               |
+-------------------------------------------+---------------------------------------+----------------------------------------------------------------+
| [lftp sync using dataq](#ldataq)          | Large datasets with many files and    | - [Robust, runs in background]{style="color: blue;"}           |
...
|                                           |                                       |   + [`dataq` copy and sync]{style="color: blue;"}              |
...
Since the connection will be terminated if your computer sleeps, terminal crashes, network drops out etc, this method is not particularly robust for large transfers. For these rather use the queue based methods (either `copyq` or Gadi or `dtq` on Artemis) described below.
