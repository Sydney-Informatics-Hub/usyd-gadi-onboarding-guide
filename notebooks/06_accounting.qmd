...
- Requests for more scratch disk, scratch inode, and gdata inode can be made through the [NCI help desk](https://nci.org.au/users/nci-helpdesk), and will require justification
- Requests for more gdata disk can be made by [emailing the Sydney Scheme manager](mailto:nci-sydney.scheme@sydney.edu.au), and will require justification
