...
|:---------|:----|:----|:---------|
| Service unit allocation for running jobs | Sydney Scheme managers | [Make a request](https://nci.sydney.edu.au/) | [Sydney Documentation](https://sydneyuni.atlassian.net/wiki/spaces/RC/pages/3448733944/NCI-Sydney+Scheme). Use [VPN](https://sydneyuni.service-now.com/sm?id=kb_article_view&sysparm_article=KB0011460) if off the USyd network. |
